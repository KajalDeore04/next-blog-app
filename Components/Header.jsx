    ...
    return (
        <div className='px-5 py-5 md:px-12 lg:px-28'>
            ...
            <div className='text-center my-8'>
                ...
                <p className='mt-10 max-w-[740px] m-auto text-xs sm:text-base'>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Nemo, delectus. Nulla nisi blanditiis placeat, molestiae cupiditate atque molestias debitis tempora reiciendis distinctio id.</p>
